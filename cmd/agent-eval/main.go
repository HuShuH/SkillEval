...
func validateCommand(args []string) error {
	...
	validationErrors := validateSkills(reg.List())
	validationErrors = append(validationErrors, validateTestCases(testCases, reg)...)
...
func validateSkills(skills []spec.SkillSpec) []string {
...
func validateTestCases(testCases []spec.TestCase, reg *registry.Registry) []string {
	errors := make([]string, 0)
